...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.laurinka.android.golf.puttingzones";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Putting zones";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.laurinka.android.golf.puttingzones.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.laurinka.android.golf.puttingzones.";
