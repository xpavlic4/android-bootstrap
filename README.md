...
* Putting zones is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Putting zones is mean to act as a starting point for Android Applications.

# Putting zones App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-laurinka-android-golf-puttingzones.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-laurinka-android-golf-puttingzones)

This repository contains the source code for the [Putting zones](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.laurinka.android.golf.puttingzones).

Please see the [issues](https://github.com.laurinka.android.golf.puttingzones/com-laurinka-android-golf-puttingzones/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Putting zones? Ask away on the [com-laurinka-android-golf-puttingzones discussion forum](https://groups.google.com/forum/#!forum/com-laurinka-android-golf-puttingzones).

<a href="https://play.google.com/store/apps/details?id=com.laurinka.android.golf.puttingzones" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.laurinka.android.golf.puttingzones__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.laurinka.android.golf.puttingzones__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.laurinka.android.golf.puttingzones.R__) will now be renamed
...
signed with a different key.  Manually uninstall Putting zones from your device and
...
Putting zones is a result of a template project I've developed over the years as well as
...
Putting zones is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.laurinka.android.golf.puttingzones/com-laurinka-android-golf-puttingzones/contributors) on
...
[pull requests](https://github.com.laurinka.android.golf.puttingzones/com-laurinka-android-golf-puttingzones/pulls).
